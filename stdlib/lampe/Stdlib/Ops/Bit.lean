...
@[reducible]
def not {p}
    (generics : HList Kind.denote «std::ops::bit::Not».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::Not».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::Not».not.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::Not».not.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::Not».not.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::Not».not generics Self associatedTypes fnGenerics
...
@[reducible]
def bitOr {p}
    (generics : HList Kind.denote «std::ops::bit::BitOr».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::BitOr».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::BitOr».bitor.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::BitOr».bitor.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::BitOr».bitor.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::BitOr».bitor generics Self associatedTypes fnGenerics
...
@[reducible]
def bitAnd {p}
    (generics : HList Kind.denote «std::ops::bit::BitAnd».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::BitAnd».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::BitAnd».bitand.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::BitAnd».bitand.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::BitAnd».bitand.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::BitAnd».bitand generics Self associatedTypes fnGenerics
...
@[reducible]
def bitXor {p}
    (generics : HList Kind.denote «std::ops::bit::BitXor».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::BitXor».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::BitXor».bitxor.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::BitXor».bitxor.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::BitXor».bitxor.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::BitXor».bitxor generics Self associatedTypes fnGenerics
...
@[reducible]
def shl {p}
    (generics : HList Kind.denote «std::ops::bit::Shl».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::Shl».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::Shl».shl.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::Shl».shl.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::Shl».shl.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::Shl».shl generics Self associatedTypes fnGenerics
...
@[reducible]
def shr {p}
    (generics : HList Kind.denote «std::ops::bit::Shr».«#genericKinds»)
    (Self : Tp)
    (associatedTypes : HList Kind.denote «std::ops::bit::Shr».«#associatedTypesKinds»)
    (fnGenerics : HList Kind.denote «std::ops::bit::Shr».shr.«#genericKinds»)
  : HList (Tp.denote p)
      («std::ops::bit::Shr».shr.«#inputs» generics Self associatedTypes fnGenerics)
  → Expr (Tp.denote p)
      («std::ops::bit::Shr».shr.«#output» generics Self associatedTypes fnGenerics) :=
  «std::ops::bit::Shr».shr generics Self associatedTypes fnGenerics
