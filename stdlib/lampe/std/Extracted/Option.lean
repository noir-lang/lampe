...
noir_trait_impl[std.impl_73]<T: Type> std::default::Default<> for std::option::Option<T> where [] := {
  noir_def default<>() -> std::option::Option<T> := {
    (std::option::Option::none<T> as λ() -> std::option::Option<T>)()
  };
}

noir_trait_impl[std.impl_74]<T: Type> std::cmp::Eq<> for std::option::Option<T> where [T: std::cmp::Eq<>] := {
...
noir_trait_impl[std.impl_75]<T: Type> std::hash::Hash<> for std::option::Option<T> where [T: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_76]<T: Type> std::cmp::Ord<> for std::option::Option<T> where [T: std::cmp::Ord<>] := {
...
def std.Option.env : Env := Env.mk
  ...
  [std.impl_73, std.impl_74, std.impl_75, std.impl_76]
