...
noir_global_def std::hash::poseidon2::RATE: u32 = (3: u32);
...
noir_def std::hash::poseidon2::Poseidon2::new<>(iv: Field) -> std::hash::poseidon2::Poseidon2<> := {
  let result = (#_ref returning & std::hash::poseidon2::Poseidon2<>)((#_makeData returning std::hash::poseidon2::Poseidon2<>)((#_mkRepeatedArray returning Array<Field, 3: u32>)((0: Field)), (#_mkRepeatedArray returning Array<Field, 4: u32>)((0: Field)), (0: u32), #_false));
  ((result.1: Array<Field, 4: u32>)[(std::hash::poseidon2::RATE<> as λ() -> u32)()]: Field) = iv;
  (#_readRef returning std::hash::poseidon2::Poseidon2<>)(result)
}
...
noir_def std::hash::poseidon2::Poseidon2::perform_duplex<>(self: & std::hash::poseidon2::Poseidon2<>) -> Unit := {
  ...
  ((*self: std::hash::poseidon2::Poseidon2<>).1: Array<Field, 4: u32>) = (#_poseidon2Permutation returning Array<Field, 4: u32>)((#_readRef returning std::hash::poseidon2::Poseidon2<>)(self).1);
  #_skip
}
...
noir_def std::hash::poseidon2::Poseidon2::absorb<>(self: & std::hash::poseidon2::Poseidon2<>, input: Field) -> Unit := {
  ...
  if (#_uEq returning bool)((#_readRef returning std::hash::poseidon2::Poseidon2<>)(self).2, (std::hash::poseidon2::RATE<> as λ() -> u32)()) then {
    ...
    {
      let i_2755 = (#_readRef returning std::hash::poseidon2::Poseidon2<>)(self).2;
      (((*self: std::hash::poseidon2::Poseidon2<>).0: Array<Field, 3: u32>)[i_2755]: Field) = input;
      #_skip
    };
...
noir_def std::hash::poseidon2::Poseidon2::hash_internal<N: u32>(input: Array<Field, N: u32>, in_len: u32, is_variable_length: bool) -> Field := {
  ...
  let sponge = (#_ref returning & std::hash::poseidon2::Poseidon2<>)((std::hash::poseidon2::Poseidon2::new<> as λ(Field) -> std::hash::poseidon2::Poseidon2<>)(iv));
  for i in (0: u32) .. (#_arrayLen returning u32)(input) do {
    if (#_uLt returning bool)(i, in_len) then {
      (std::hash::poseidon2::Poseidon2::absorb<> as λ(& std::hash::poseidon2::Poseidon2<>, Field) -> Unit)(sponge, (#_arrayIndex returning Field)(input, (#_cast returning u32)(i)));
      #_skip
    }
  };
  if is_variable_length then {
    (std::hash::poseidon2::Poseidon2::absorb<> as λ(& std::hash::poseidon2::Poseidon2<>, Field) -> Unit)(sponge, (1: Field));
    #_skip
  };
  (std::hash::poseidon2::Poseidon2::squeeze<> as λ(& std::hash::poseidon2::Poseidon2<>) -> Field)(sponge)
}

noir_trait_impl[std.impl_0]<> std::hash::Hasher<> for std::hash::poseidon2::Poseidon2Hasher<> where [] := {
  noir_def finish<>(self: std::hash::poseidon2::Poseidon2Hasher<>) -> Field := {
    ...
    for i in (0: u32) .. (#_arrayLen returning u32)(self.0) do {
      (std::hash::poseidon2::Poseidon2::absorb<> as λ(& std::hash::poseidon2::Poseidon2<>, Field) -> Unit)(sponge, (#_vectorIndex returning Field)(self.0, (#_cast returning u32)(i)));
      #_skip
    };
    (std::hash::poseidon2::Poseidon2::squeeze<> as λ(& std::hash::poseidon2::Poseidon2<>) -> Field)(sponge)
  };
  ...
  noir_def write<>(self: & std::hash::poseidon2::Poseidon2Hasher<>, input: Field) -> Unit := {
    ((*self: std::hash::poseidon2::Poseidon2Hasher<>).0: Vector<Field>) = (#_vectorPushBack returning Vector<Field>)((#_readRef returning std::hash::poseidon2::Poseidon2Hasher<>)(self).0, input);
    #_skip
  };
}

noir_trait_impl[std.impl_1]<> std::default::Default<> for std::hash::poseidon2::Poseidon2Hasher<> where [] := {
  noir_def default<>() -> std::hash::poseidon2::Poseidon2Hasher<> := {
    (#_makeData returning std::hash::poseidon2::Poseidon2Hasher<>)((#_asVector returning Vector<Field>)((#_mkArray returning Array<Field, 0: u32>)()))
  };
}

def std.Hash.Poseidon2.env : Env := Env.mk
  [«std::hash::poseidon2::RATE», «std::hash::poseidon2::Poseidon2::hash», «std::hash::poseidon2::Poseidon2::new», «std::hash::poseidon2::Poseidon2::perform_duplex», «std::hash::poseidon2::Poseidon2::absorb», «std::hash::poseidon2::Poseidon2::squeeze», «std::hash::poseidon2::Poseidon2::hash_internal»]
  [std.impl_0, std.impl_1]
