...
noir_def std::hash::pedersen_commitment_with_separator<N: u32>(input: Array<Field, N: u32>, separator: u32) -> std::embedded_curve_ops::EmbeddedCurvePoint<> := {
  let points = (#_ref returning & Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, N: u32>)((#_mkRepeatedArray returning Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, N: u32>)((#_makeData returning std::embedded_curve_ops::EmbeddedCurveScalar<>)((0: Field), (0: Field))));
  ...
  (std::embedded_curve_ops::multi_scalar_mul<N: u32> as λ(Array<std::embedded_curve_ops::EmbeddedCurvePoint<>, N: u32>, Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, N: u32>) -> std::embedded_curve_ops::EmbeddedCurvePoint<>)(generators, (#_readRef returning Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, N: u32>)(points))
}
...
noir_def std::hash::pedersen_hash_with_separator<N: u32>(input: Array<Field, N: u32>, separator: u32) -> Field := {
  let scalars = (#_ref returning & Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, (N + 1): u32>)((#_mkRepeatedArray returning Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, (N + 1): u32>)((#_makeData returning std::embedded_curve_ops::EmbeddedCurveScalar<>)((0: Field), (0: Field))));
  let generators = (#_ref returning & Array<std::embedded_curve_ops::EmbeddedCurvePoint<>, (N + 1): u32>)((#_mkRepeatedArray returning Array<std::embedded_curve_ops::EmbeddedCurvePoint<>, (N + 1): u32>)((std::embedded_curve_ops::EmbeddedCurvePoint::point_at_infinity<> as λ() -> std::embedded_curve_ops::EmbeddedCurvePoint<>)()));
  ...
  (#_arrayIndex returning std::embedded_curve_ops::EmbeddedCurvePoint<>)((#_multiScalarMul returning Array<std::embedded_curve_ops::EmbeddedCurvePoint<>, 1: u32>)((#_readRef returning Array<std::embedded_curve_ops::EmbeddedCurvePoint<>, (N + 1): u32>)(generators), (#_readRef returning Array<std::embedded_curve_ops::EmbeddedCurveScalar<>, (N + 1): u32>)(scalars), #_true), (0: u32)).0
}
...
noir_def std::hash::from_field_unsafe<>(scalar: Field) -> std::embedded_curve_ops::EmbeddedCurveScalar<> := {
  ...
  let (a, b) = if (#_fEq returning bool)(xhi, (std::field::bn254::PHI<> as λ() -> Field)()) then {
    (#_makeData returning Tuple<Field, Field>)(xlo, (std::field::bn254::PLO<> as λ() -> Field)())
  } else {
    (#_makeData returning Tuple<Field, Field>)(xhi, (std::field::bn254::PHI<> as λ() -> Field)())
  };
  (std::field::bn254::assert_lt<> as λ(Field, Field) -> Unit)(a, b);
  (#_makeData returning std::embedded_curve_ops::EmbeddedCurveScalar<>)(xlo, xhi)
}

noir_def std::hash::poseidon2_permutation<N: u32>(input: Array<Field, N: u32>, state_len: u32) -> Array<Field, N: u32> := {
...
noir_trait_impl[std.impl_2]<H: Type> std::hash::BuildHasher<> for std::hash::BuildHasherDefault<H> where [H: std::hash::Hasher<>, H: std::default::Default<>] := {
  noir_def build_hasher<>(_self: std::hash::BuildHasherDefault<H>) -> H := {
    ((H as std::default::Default<>)::default<> as λ() -> H)()
  };
}

noir_trait_impl[std.impl_3]<H: Type> std::default::Default<> for std::hash::BuildHasherDefault<H> where [H: std::hash::Hasher<>, H: std::default::Default<>] := {
  noir_def default<>() -> std::hash::BuildHasherDefault<H> := {
    (#_makeData returning std::hash::BuildHasherDefault<H>)()
  };
}

noir_trait_impl[std.impl_4]<> std::hash::Hash<> for Field where [] := {
...
noir_trait_impl[std.impl_5]<> std::hash::Hash<> for u1 where [] := {
...
noir_trait_impl[std.impl_6]<> std::hash::Hash<> for u8 where [] := {
...
noir_trait_impl[std.impl_7]<> std::hash::Hash<> for u16 where [] := {
...
noir_trait_impl[std.impl_8]<> std::hash::Hash<> for u32 where [] := {
...
noir_trait_impl[std.impl_9]<> std::hash::Hash<> for u64 where [] := {
...
noir_trait_impl[std.impl_10]<> std::hash::Hash<> for u128 where [] := {
...
noir_trait_impl[std.impl_11]<> std::hash::Hash<> for i8 where [] := {
...
noir_trait_impl[std.impl_12]<> std::hash::Hash<> for i16 where [] := {
...
noir_trait_impl[std.impl_13]<> std::hash::Hash<> for i32 where [] := {
...
noir_trait_impl[std.impl_14]<> std::hash::Hash<> for i64 where [] := {
...
noir_trait_impl[std.impl_15]<> std::hash::Hash<> for bool where [] := {
...
noir_trait_impl[std.impl_16]<> std::hash::Hash<> for Unit where [] := {
  noir_def hash<H: Type>(_self: Unit, _state: & H) -> Unit := {
    #_skip
  };
}

noir_trait_impl[std.impl_17]<N: u32, T: Type> std::hash::Hash<> for Array<T, N: u32> where [T: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_18]<T: Type> std::hash::Hash<> for Vector<T> where [T: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_19]<A: Type, B: Type> std::hash::Hash<> for Tuple<A, B> where [A: std::hash::Hash<>, B: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_20]<A: Type, B: Type, C: Type> std::hash::Hash<> for Tuple<A, B, C> where [A: std::hash::Hash<>, B: std::hash::Hash<>, C: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_21]<A: Type, B: Type, C: Type, D: Type> std::hash::Hash<> for Tuple<A, B, C, D> where [A: std::hash::Hash<>, B: std::hash::Hash<>, C: std::hash::Hash<>, D: std::hash::Hash<>] := {
...
noir_trait_impl[std.impl_22]<A: Type, B: Type, C: Type, D: Type, E: Type> std::hash::Hash<> for Tuple<A, B, C, D, E> where [A: std::hash::Hash<>, B: std::hash::Hash<>, C: std::hash::Hash<>, D: std::hash::Hash<>, E: std::hash::Hash<>] := {
...
def std.Hash.Mod.env : Env := Env.mk
  [«std::hash::blake3», «std::hash::pedersen_commitment», «std::hash::pedersen_commitment_with_separator», «std::hash::pedersen_hash», «std::hash::pedersen_hash_with_separator», «std::hash::derive_generators», «std::hash::from_field_unsafe», «std::hash::poseidon2_permutation», «std::hash::assert_pedersen»]
  [std.impl_2, std.impl_3, std.impl_4, std.impl_5, std.impl_6, std.impl_7, std.impl_8, std.impl_9, std.impl_10, std.impl_11, std.impl_12, std.impl_13, std.impl_14, std.impl_15, std.impl_16, std.impl_17, std.impl_18, std.impl_19, std.impl_20, std.impl_21, std.impl_22]
