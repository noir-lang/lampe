...
noir_def std::array::fold<T: Type, N: u32, U: Type, Env: Type>(self: Array<T, N: u32>, accumulator: U, f: λ(U, T) -> U) -> U := {
...
noir_def std::array::sort<T: Type, N: u32>(self: Array<T, N: u32>) -> Array<T, N: u32> := {
  (std::array::sort_via<T, N: u32, Unit> as λ(Array<T, N: u32>, λ(T, T) -> bool) -> Array<T, N: u32>)(self, (fn(a: T, b: T): bool := {
    let __0 = ((T as std::cmp::Ord<>)::cmp<> as λ(T, T) -> std::cmp::Ordering<>)(a, b);
    let __1 = (std::cmp::Ordering::less<> as λ() -> std::cmp::Ordering<>)();
    let __3 = (std::cmp::Ordering::equal<> as λ() -> std::cmp::Ordering<>)();
    let __7 = ((std::cmp::Ordering<> as std::cmp::Eq<>)::eq<> as λ(std::cmp::Ordering<>, std::cmp::Ordering<>) -> bool)(__0, __1);
    let __15 = ((std::cmp::Ordering<> as std::cmp::Eq<>)::eq<> as λ(std::cmp::Ordering<>, std::cmp::Ordering<>) -> bool)(__0, __3);
...
noir_trait_impl[std.impl_24]<N: u32> std::convert::From<String<N: u32> > for Array<u8, N: u32> where [] := {
...
noir_def std::array::test::test_sort<>() -> Unit := {
  ...
  let sorted = (std::array::sort<u32, 7: u32> as λ(Array<u32, 7: u32>) -> Array<u32, 7: u32>)((#_readRef returning Array<u32, 7: u32>)(arr));
...
noir_def std::array::test::test_sort_100_values<>() -> Unit := {
  ...
  let sorted = (std::array::sort<u32, 100: u32> as λ(Array<u32, 100: u32>) -> Array<u32, 100: u32>)((#_readRef returning Array<u32, 100: u32>)(arr));
...
noir_def std::array::test::test_sort_via<>() -> Unit := {
  let arr = (#_ref returning & Array<u32, 7: u32>)((#_mkArray returning Array<u32, 7: u32>)((3: u32), (6: u32), (8: u32), (10: u32), (1: u32), (2: u32), (1: u32)));
  let sorted = (std::array::sort_via<u32, 7: u32, Unit> as λ(Array<u32, 7: u32>, λ(u32, u32) -> bool) -> Array<u32, 7: u32>)((#_readRef returning Array<u32, 7: u32>)(arr), (std::array::test::sort_u32<> as λ(u32, u32) -> bool));
  let expected = (#_mkArray returning Array<u32, 7: u32>)((1: u32), (1: u32), (2: u32), (3: u32), (6: u32), (8: u32), (10: u32));
  (#_assert returning Unit)(((Array<u32, 7: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 7: u32>, Array<u32, 7: u32>) -> bool)(sorted, expected));
  #_skip
}
...
noir_def std::array::test::test_sort_via_100_values<>() -> Unit := {
  let arr = (#_ref returning & Array<u32, 100: u32>)((#_mkArray returning Array<u32, 100: u32>)((42: u32), (123: u32), (87: u32), (93: u32), (48: u32), (80: u32), (50: u32), (5: u32), (104: u32), (84: u32), (70: u32), (47: u32), (119: u32), (66: u32), (71: u32), (121: u32), (3: u32), (29: u32), (42: u32), (118: u32), (2: u32), (54: u32), (89: u32), (44: u32), (81: u32), (0: u32), (26: u32), (106: u32), (68: u32), (96: u32), (84: u32), (48: u32), (95: u32), (54: u32), (45: u32), (32: u32), (89: u32), (100: u32), (109: u32), (19: u32), (37: u32), (41: u32), (19: u32), (98: u32), (53: u32), (114: u32), (107: u32), (66: u32), (6: u32), (74: u32), (13: u32), (19: u32), (105: u32), (64: u32), (123: u32), (28: u32), (44: u32), (50: u32), (89: u32), (58: u32), (123: u32), (126: u32), (21: u32), (43: u32), (86: u32), (35: u32), (21: u32), (62: u32), (82: u32), (0: u32), (108: u32), (120: u32), (72: u32), (72: u32), (62: u32), (80: u32), (12: u32), (71: u32), (70: u32), (86: u32), (116: u32), (73: u32), (38: u32), (15: u32), (127: u32), (81: u32), (30: u32), (8: u32), (125: u32), (28: u32), (26: u32), (69: u32), (114: u32), (63: u32), (27: u32), (28: u32), (61: u32), (42: u32), (13: u32), (32: u32)));
  let sorted = (std::array::sort_via<u32, 100: u32, Unit> as λ(Array<u32, 100: u32>, λ(u32, u32) -> bool) -> Array<u32, 100: u32>)((#_readRef returning Array<u32, 100: u32>)(arr), (std::array::test::sort_u32<> as λ(u32, u32) -> bool));
  let expected = (#_mkArray returning Array<u32, 100: u32>)((0: u32), (0: u32), (2: u32), (3: u32), (5: u32), (6: u32), (8: u32), (12: u32), (13: u32), (13: u32), (15: u32), (19: u32), (19: u32), (19: u32), (21: u32), (21: u32), (26: u32), (26: u32), (27: u32), (28: u32), (28: u32), (28: u32), (29: u32), (30: u32), (32: u32), (32: u32), (35: u32), (37: u32), (38: u32), (41: u32), (42: u32), (42: u32), (42: u32), (43: u32), (44: u32), (44: u32), (45: u32), (47: u32), (48: u32), (48: u32), (50: u32), (50: u32), (53: u32), (54: u32), (54: u32), (58: u32), (61: u32), (62: u32), (62: u32), (63: u32), (64: u32), (66: u32), (66: u32), (68: u32), (69: u32), (70: u32), (70: u32), (71: u32), (71: u32), (72: u32), (72: u32), (73: u32), (74: u32), (80: u32), (80: u32), (81: u32), (81: u32), (82: u32), (84: u32), (84: u32), (86: u32), (86: u32), (87: u32), (89: u32), (89: u32), (89: u32), (93: u32), (95: u32), (96: u32), (98: u32), (100: u32), (104: u32), (105: u32), (106: u32), (107: u32), (108: u32), (109: u32), (114: u32), (114: u32), (116: u32), (118: u32), (119: u32), (120: u32), (121: u32), (123: u32), (123: u32), (123: u32), (125: u32), (126: u32), (127: u32));
  (#_assert returning Unit)(((Array<u32, 100: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 100: u32>, Array<u32, 100: u32>) -> bool)(sorted, expected));
  #_skip
}
...
noir_def std::array::test::for_each_example<>() -> Unit := {
  ...
  (#_assert returning Unit)(((Array<Field, 3: u32> as std::cmp::Eq<>)::eq<> as λ(Array<Field, 3: u32>, Array<Field, 3: u32>) -> bool)((#_readRef returning Array<Field, 3: u32>)(b), (#_mkArray returning Array<Field, 3: u32>)((2: Field), (4: Field), (6: Field))));
...
noir_def std::array::test::for_eachi_example<>() -> Unit := {
  ...
  (#_assert returning Unit)(((Array<u32, 3: u32> as std::cmp::Eq<>)::eq<> as λ(Array<u32, 3: u32>, Array<u32, 3: u32>) -> bool)((#_readRef returning Array<u32, 3: u32>)(b), (#_mkArray returning Array<u32, 3: u32>)((2: u32), (5: u32), (8: u32))));
  #_skip
}
...
noir_def std::array::test::concat<>() -> Unit := {
  ...
  let concatenated_arr = (std::array::concat<Field, 4: u32, 6: u32> as λ(Array<Field, 4: u32>, Array<Field, 6: u32>) -> Array<Field, 10: u32>)(arr1, arr2);
  (#_assert returning Unit)(((Array<Field, 10: u32> as std::cmp::Eq<>)::eq<> as λ(Array<Field, 10: u32>, Array<Field, 10: u32>) -> bool)(concatenated_arr, (#_mkArray returning Array<Field, 10: u32>)((1: Field), (2: Field), (3: Field), (4: Field), (6: Field), (7: Field), (8: Field), (9: Field), (10: Field), (11: Field))));
  #_skip
}
...
noir_def std::array::test::concat_zero_length_with_something<>() -> Unit := {
  ...
  let concatenated_arr = (std::array::concat<Field, 0: u32, 1: u32> as λ(Array<Field, 0: u32>, Array<Field, 1: u32>) -> Array<Field, 1: u32>)(arr1, arr2);
  (#_assert returning Unit)(((Array<Field, 1: u32> as std::cmp::Eq<>)::eq<> as λ(Array<Field, 1: u32>, Array<Field, 1: u32>) -> bool)(concatenated_arr, (#_mkArray returning Array<Field, 1: u32>)((1: Field))));
  #_skip
}
...
noir_def std::array::test::concat_something_with_zero_length<>() -> Unit := {
  ...
  let concatenated_arr = (std::array::concat<Field, 1: u32, 0: u32> as λ(Array<Field, 1: u32>, Array<Field, 0: u32>) -> Array<Field, 1: u32>)(arr1, arr2);
  (#_assert returning Unit)(((Array<Field, 1: u32> as std::cmp::Eq<>)::eq<> as λ(Array<Field, 1: u32>, Array<Field, 1: u32>) -> bool)(concatenated_arr, (#_mkArray returning Array<Field, 1: u32>)((1: Field))));
  #_skip
}
...
noir_def std::array::test::concat_zero_lengths<>() -> Unit := {
  let arr1 = (#_mkArray returning Array<Field, 0: u32>)();
  let arr2 = (#_mkArray returning Array<Field, 0: u32>)();
  let concatenated_arr = (std::array::concat<Field, 0: u32> as λ(Array<Field, 0: u32>, Array<Field, 0: u32>) -> Array<Field, 0: u32>)(arr1, arr2);
  (#_assert returning Unit)(((Array<Field, 0: u32> as std::cmp::Eq<>)::eq<> as λ(Array<Field, 0: u32>, Array<Field, 0: u32>) -> bool)(concatenated_arr, (#_mkArray returning Array<Field, 0: u32>)()));
  #_skip
}

def std.Array.Mod.env : Env := Env.mk
