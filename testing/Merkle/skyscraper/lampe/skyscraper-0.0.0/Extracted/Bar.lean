...
noir_def «skyscraper-0.0.0»::bar::bar<>(a: Field) -> Field := {
  let bytes = (std::field::to_le_bytes<32: u32> as λ(Field) -> Array<u8, 32: u32>)(a);
  ...
  let new_bytes_array = (std::vector::as_array<u8, 32: u32> as λ(Vector<u8>) -> Array<u8, 32: u32>)((#_readRef returning Vector<u8>)(new_bytes));
  (std::field::from_le_bytes<32: u32> as λ(Array<u8, 32: u32>) -> Field)(new_bytes_array)
}
